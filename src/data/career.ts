...
export const summary =
  "Webフロントエンドを中心に、WordPress、EC-CUBE、Shopifyを用いたサイト・EC構築、Nuxt.js + LaravelでのWebアプリ開発にも携わる。社内勉強会の企画・運営や、チームリーダーとして新人育成にも携わり、技術・マネジメント両面でスキルを蓄積してきました。";
...
export const career: CareerEntry[] = [
    ...
    sub: [
      {
        ...
        description:
          "自社開発の業務効率化サービス「Huddler」の開発(Nuxt.js、Laravel、Stripe)に携わる。Laravelでのデータ処理や、Stripeを用いたサブスクリプション課金機能を担当。",
      },
      {
        period: "2022.09 -",
  ...
  },
  {
    ...
    company: "フリーランス",
    description: "Webサイト制作(コーディング中心)・運用保守。",
  },
  {
  ...
  },
  {
    ...
    company: "株式会社カリア",
    description: "代表取締役として、営業から企画・デザイン・フロントエンド制作、保守運用まで一貫して担当。",
  },
  {
  ...
  },
  {
    ...
    description: "医療・介護業界のWebサイト制作、インタビュー動画の撮影補助・編集を担当。",
  },
];
